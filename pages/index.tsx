...
export default function Home() {
 ...
 const meta = {
   title: "Bishnu Thapa - Web3 Developer",
   description: `I specialize in crafting exceptional digital experiences in the web3 domain. Let's connect to explore more.`,
